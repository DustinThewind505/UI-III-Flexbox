...
* [ ] Services Page Build:
  * XXXXXX Update the title in your newly copied services page to say `Great Idea! - Services`
  ...
  * XXXXXX  Wrap the great idea logo in an anchor tag and point the `href` to `index.html`
